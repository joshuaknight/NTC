...
var final_ele = function(){
			$("#add_event_url")[0].style.visibility = "visible";		
			var template_personal_note = ''+
										'<div class="row-fluid"> '+
										'	 <div class="span12">'+
										'		<div class="well form-search ">'+
								        '		<fieldset>'+
								        '		<legend>Welcome to the Cornerstone Event'+
								        '			Manager</legend>'+
										'        <p>'+
								        '            Dear <p id="family_name_after_registration"> </p> ,'+
								        '		</p>'+
										'        <p>'+
										'		We are pleased to inform you that the registration was  successfull, a person from our side will'+
										'		contact you, and also if you have any queries you can contact us via email or by using the contact form'+
										'		in our website, You can also edit your profile anytime  by logging in with the userid and password provided'+ 
										'		below,'+
										'		</p>'+                                
								        '	<p>Once again have a wonderfull day</p>'+
								        '		<p>'+
								        '			The userid and Password are CaseSensitive'+					
								        '			please email the development team at <a href="mailto:cornerstone@ntchq.org">cornerstone@ntchq.org</a>'+
								        '		</p>'+
								        '		<ul>'+
								        '			<li>Userid     <p id="userid"></p></li>'+
								        '			<li>Password   <p id="password"></p></li>'+
								        '			</ul>'+
								        '			<p>'+
								        '			If you require immediate assistance, please call <strong>Sue George @ 551-587-8301.</strong>'+
								        '			</p>'+
								        '			<p>'+
								        '			The Convention Registration Team.</p>'+
								        '		</fieldset>'+
										'		</div>'+
										'		</div>'+
										'		</div> '
			...
			var container = $("#add_personal_note")[0];	

			var html_node = $(template_personal_note)[0];

			$(html_node).find("#family_name_after_registration")[0].innerHTML = txt_family_name.value;
			$(html_node).find("#userid")[0].innerHTML = txt_family_name.value;
			$(html_node).find("#password")[0].innerHTML = txt_family_name.value + '_' + family_id;

			$(container).append(html_node);
}
